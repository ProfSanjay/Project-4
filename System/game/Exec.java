...
{	
	...
	public static void main(String[] args)
	{
		...
		if (args.length > 0)
		{
			...
			exec.runGame(attacker, studentDefender, true, _Game.DELAY); // Comment out for testing

		//this can be used for numerical testing (non-visual, no delays)
//		exec.runExperiment(attacker, studentDefender, 100, false); // Uncomment for testing
